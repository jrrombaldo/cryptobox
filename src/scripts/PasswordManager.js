...
class PasswordManager {
    ...
    getPasswordApp() { return this.instance.getPasswordApp () }
    searchForPassword() { return this.instance.searchForPassword () }
    savePassword(password) { return this.instance.savePassword () }
    getAccountName(sourceFolder) { return this.instance.getAccountName () }
}
